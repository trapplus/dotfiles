...
class ShellController:
    def __init__(self) -> None:
        ...
        if self.SYSTEM != "Linux":
            raise SystemError("Script is runned in not compitable system!")
    ...
    @staticmethod
    def run_command(
        command: str, shell: bool = True, capture_output: bool = True, text: bool = True
    ) -> CompletedProcess:
        """
        ...
        """
        result = run(command, shell=shell, capture_output=capture_output, text=text)
    ...
    def clear_terminal(self) -> None:
        self.run_command("clear", shell=False, capture_output=False, text=False)

    def restart(self) -> None:
        self.run_command("zsh", shell=False, capture_output=False, text=False)
